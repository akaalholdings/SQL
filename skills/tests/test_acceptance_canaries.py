...
recall_lessons(skill=sql-health-triage, skill_version=1.0.0,
...
unchanged.
recall_lessons(skill=sql-optimizer, skill_version=2.3.0,
runtime_compatibility_fingerprint=compat-1,
tool_schema_fingerprint=schema-1, sanitized_config_fingerprint=config-1,
database_name=selected) was unavailable because learning is remote-disabled;
recall_lessons(skill=sql-plan-enforcer, skill_version=1.0.0,
runtime_compatibility_fingerprint=compat-1,
tool_schema_fingerprint=schema-1, sanitized_config_fingerprint=config-1,
database_name=selected) was unavailable because learning is remote-disabled.
Evidence reference: evidence-health-1 and terminal-plan-review-1.
DecisionRecordV1: record_decision(skill=sql-health-triage, skill_version=1.0.0,
...
skill_version=1.0.0, subject_kind=database,
...
record_decision(skill=sql-optimizer, skill_version=2.3.0, subject_kind=query,
...
Plan control: record_decision(skill=sql-plan-enforcer, skill_version=1.0.0,
...
def test_all_three_acceptance_validators_accept_the_same_ordered_trace() -> None:
